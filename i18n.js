...
(function initializeI18n(global) {
  ...
  const staticTranslations = {
    ...
    "Source code:": "原始碼：",
    "Created by": "製作：",
    "The hosted site uses Cloudflare Pages for delivery and Protico services for product guidance and user support. Calculator inputs and equations still run in the browser.": "線上版本使用 Cloudflare Pages 進行網站遞送，並使用 Protico 服務提供產品引導與用戶支援。試算輸入與方程式仍在瀏覽器中執行。",
